...
local proto_pfields = {
    ...
    value    = ProtoField.bytes ("protobuf.value", "Value", base.SPACE, "Field value bytes"),
    ...
    GROUP    = ProtoField.bytes ("protobuf.group", "Group", base.SPACE, "Unknown Group Field"),
    LENGTH_BYTES = ProtoField.bytes("protobuf.length_delimited_bytes", "Length Delimited Bytes", base.SPACE, "Unknown Length Delimited Field"),
}
